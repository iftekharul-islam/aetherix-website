...
export default function FlipCard({
    ...
    return (
        <Link href={href} className='block w-full h-80 group [perspective:1000px]' onClick={handleCardClick}>
            <div className={`relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] ${isFlipped ? '[transform:rotateY(180deg)]' : ''}`}>
                ...
                <div className='absolute w-full h-full backface-hidden rounded-lg overflow-hidden shadow-lg transform group-hover:scale-105 transition-all duration-500'>
                    <Image src={imageSrc} alt={title} fill className='object-cover transition-transform duration-1000 group-hover:scale-110' />
